...
bool UNIT_TEST_Configuration::Configuration06()
{
    string name = "Configuration06";
    //! data ------------------------------------
    string filePath = "test/unit_test_Configuration/test_case/input/config6.txt";
    int NUM_ROWS = 0;
    int NUM_COLS = 0;
    ...
    //! expect ----------------------------------
    string expect = 
R"expect(NUM_ROWS: 10
NUM_COLS: 8
RIV ROA ROA ROA RIV ROA ROA ROA
ROA ROA FOR ROA ROA ROA ROA ROA
URB ROA ROA ROA ROA ROA ROA ROA
ROA ROA ROA ROA ROA FOR ROA ROA
ROA ROA ROA ROA ROA ROA ROA ROA
ROA ROA ROA ROA ROA ROA ROA ROA
ROA ROA ROA ROA ROA ROA FOR ROA
ROA ROA ROA ROA ROA ROA ROA ROA
ROA ROA ROA ROA ROA ROA ROA ROA
ROA ROA ROA ROA ROA ROA ROA SPE
[
SNIPER(5,2,(1,2),0),
SNIPER(5,2,(3,2),1),
