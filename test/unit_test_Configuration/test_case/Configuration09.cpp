...
bool UNIT_TEST_Configuration::Configuration09()
{
    string name = "Configuration09";
    //! data ------------------------------------
    string filePath = "test/unit_test_Configuration/test_case/input/config9.txt";
    int NUM_ROWS = 0;
    int NUM_COLS = 0;
...
SPE ROA ROA ROA
[
REGULARINFANTRY(10,5,(1,0),0),
SPECIALFORCES(8,3,(3,3),1)
]
EVENT_CODE: 42
)expect";
